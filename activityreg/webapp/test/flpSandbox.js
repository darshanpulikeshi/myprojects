		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comtestactivityreg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestactivityreg-display": {
								"semanticObject": "comtestactivityreg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.activityreg",
									"url": sap.ui.require.toUrl("com/test/activityreg")
								}
							}
						}
					}
